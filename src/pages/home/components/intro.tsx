      ...
      <div className="intro-association">
        <div className="intro-association__container">
          <div className="intro-association__column intro-association__column--1">
            ...
            <p>Well, let’s just say <s>William McKinley</s>’s association with the community of Hawai‘i has a less than positive history.</p>
            <p>In 1897, this man thrusted Hawai‘i into the United States when he illegally* annexed the kingdom for its natural resources and strategic military location.</p>
          ...
          <div className="intro-association__column intro-association__column--2">
            ...
            <img src="https://via.placeholder.com/280x260.png/AC1D11/AC1D11" />
            <p>The native Alaskan community and its allies fought for a similar naming resolution with Mount <s>McKinley</s> for decades.</p>
