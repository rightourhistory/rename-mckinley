    ...
    return ( 
      <div className="splash">
        <div className="splash__container">
          <h1 className="splash__headline">Rename <em>McKinley</em> High School</h1>
          <a className="splash__cta" href="#">Sign the Petition</a>
        </div>
        <SplashHead />
      </div>
    )
    ...
    return (
      <div className="splash-head" ref={this.containerRef}>
        <div className="splash-head__container">
          ...
          <div className={`splash-head__eye splash-head__eye--left`} ref={this.eyeLeftRef} />
          <div className={`splash-head__eye splash-head__eye--right`} ref={this.eyeRightRef} />
        </div>
      </div>
    )
  }
  ...
  updateEyePosition(event: MouseEvent) {
    [this.eyeLeftRef.current, this.eyeRightRef.current].forEach((eye) => {
      if (eye) {
        ...
        let y =
          eye.getBoundingClientRect().top + eye.clientHeight / 2 + window.scrollY;
